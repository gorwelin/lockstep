...
<body>
  ...
  <header class="hero" id="top">
    <div class="hero-inner">
      <p class="hero-eyebrow">UK property · certainty layer</p>
      <h1>Stop shipping deals that never close.</h1>
      <p class="hero-lead">Lockstep is the sale-ready + secured rail for agents: upfront pack, binding reservation, disclosed partner fees. Stats are sourced; the model is ours to prove.</p>
